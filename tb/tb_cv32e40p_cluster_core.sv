...
module tb_cv32e40p_cluster_core #(
    ...
    localparam logic [31:0] MMADDR_DMA_SRC_STRIDE = MMADDR_DMA_BASE + 32'h0010;
    ...
    logic dma_cfg_src_stride_valid;
    logic dma_cfg_dst_stride_valid;
    ...
    assign core_is_dma = core_is_shared &&
                         ((core_data_addr == MMADDR_DMA_SRC) ||
                          ...
                          (core_data_addr == MMADDR_DMA_SRC_STRIDE) ||
                          (core_data_addr == MMADDR_DMA_DST_STRIDE) ||
    ...
    assign dma_cfg_src_stride_valid = core_data_req && core_data_gnt && core_data_we && (core_data_addr == MMADDR_DMA_SRC_STRIDE);
    assign dma_cfg_dst_stride_valid = core_data_req && core_data_gnt && core_data_we && (core_data_addr == MMADDR_DMA_DST_STRIDE);
    ...
    tb_core_dma_engine #(
        ...
        .cfg_src_stride_valid_i(dma_cfg_src_stride_valid),
        .cfg_src_stride_i(core_data_wdata),
        .cfg_dst_stride_valid_i(dma_cfg_dst_stride_valid),
        .cfg_dst_stride_i(core_data_wdata),
